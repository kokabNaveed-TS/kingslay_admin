...
CREATE TABLE IF NOT EXISTS users (
  ...
  role           ENUM('admin','operation_manager','staff','user') NOT NULL DEFAULT 'user',
...
-- Seed: Staff  (password = Admin1234  —  starts inactive)
INSERT IGNORE INTO users (username,email,phone,password,role,is_active,assigned_tools) VALUES
('staffdemo','kokab.naveed.ts@gmail.com','0412345678','$2a$10$Za5UtKe0UFfAjZMjFWmUFOl.oJTvzMbKClqIkfQmDWGW2lPPQD1SG','staff',FALSE,'[1,6,10,15]');
